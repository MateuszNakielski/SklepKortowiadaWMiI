...
namespace SklepKortowiadaWMiI.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Quantity,OrderId,ProductId")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Quantity,OrderId,ProductId")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
